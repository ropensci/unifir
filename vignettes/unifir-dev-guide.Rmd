...
(Note that, for this vignette to build on CRAN, I need to set `unity = waiver()`
to work around the lack of a Unity executable.)
...
(Note that I've set `initialize_project = FALSE` so this vignette runs on CRAN).
